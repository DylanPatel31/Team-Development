<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddCustomer.aspx.cs" Inherits="Hotel_Delux.staff.customer.AddCustomer" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="form-div">
                    <h2 class="page-title-form">Add Customer</h2>
                    ...
                    <input
                      ...
                      class="form-control"
                      placeholder="number should be 11 digit"
                    />
                </div>
                     <div class="form-group">
                    ...
                    <div class="form-group">
                     <asp:Button ID="btnSave" CssClass="btn btn-md btn-info" OnClick="btnSubmit_Click" OnClientClick=" return addStaffValidate()" runat="server" Text="Save" />
