<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Hotel_Delux.admin.staff.index" %>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                    ...
                    <h2 class="page-title-form">Staff List</h2>
                <asp:GridView ID="GridView1" AllowPaging="true" PageIndex="4" runat="server" DataKeyNames="StaffUsername,StaffName" AutoGenerateColumns="false" OnPageIndexChanging="GridView1_PageIndexChanging" OnSelectedIndexChanged="GridView1_RowSelecting" OnRowDeleting="GridView1_RowDeleting" OnRowEditing="GridView1_RowEditing">  
                    <Columns>  
                        <asp:BoundField DataField="StaffUsername" HeaderText="Username" />  
                        <asp:BoundField DataField="StaffName" HeaderText="Name" />  
                        <asp:BoundField DataField="StaffMobile" HeaderText="Mobile" />  
                        <asp:BoundField DataField="StaffState" HeaderText="State" />
