            ...
            <div class="col-one">
                <div class="center-text">
                    <form method="post" action="IssueBook_Manager.aspx" id="form1">
                        ...
                        <input type="text" name="txtBookNo" id="BookNo" placeholder="Enter Book Number." class="auto-style2"/><br />
                        <button type="submit" class="button button-dark" id="Issue" value="Issue">Issue Book</button><br />
                        <button type="button" class="button button-dark" id="Back" value="Back" onclick="goBack()" style="width: 104px; height: 40px">Back</button>
                    </form>
                </div>
            </div>
        </div>
