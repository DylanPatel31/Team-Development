...
document.bgColor=this.options[this.selectedIndex].value">
    ...
    <!-- Background-Colour changer -->
        ...
        <asp:DropDownList ID="txtUserType" runat="server" style="z-index: 1; left: 181px; top: 430px; position: absolute; height: 18px; width: 130px">
            <asp:ListItem Value="U1">U1</asp:ListItem>
        </asp:DropDownList>
