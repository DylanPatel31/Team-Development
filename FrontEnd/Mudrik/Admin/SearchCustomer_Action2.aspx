<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchCustomer_Action2.aspx.cs" Inherits="FrontEnd.Mudrik.Admin.SearchCustomer_Action2" %>
...
<body>
    ...
    <%
        ...
        if (delete != null)
        {
            //send the the delete stored procedure to the delete procedue
