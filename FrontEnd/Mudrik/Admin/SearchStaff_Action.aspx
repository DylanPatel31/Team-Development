<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchStaff_Action.aspx.cs" Inherits="FrontEnd.Mudrik.Admin.SearchStaff_Action" %>
...
<body>
   <!-- Header -->
    ...
    <form id="form1" action="SearchStaff_Action.aspx">
        <div class="container">
     <div class="one-col">
    ...
    <form  runat="server" action="SearchStaff_Action2.aspx">
    <%
