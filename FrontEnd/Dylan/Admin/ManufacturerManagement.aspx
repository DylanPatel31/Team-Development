<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManufacturerManagement.aspx.cs" Inherits="FrontEnd.Dylan.Admin.ManufacturerManagement" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:ListBox ID="lstManufacturer" runat="server" style="z-index: 1; left: 10px; top: 104px; position: absolute; height: 255px; width: 363px"></asp:ListBox>
        <asp:TextBox ID="lblManufacturerName" runat="server" style="z-index: 1; left: 11px; top: 385px; position: absolute; width: 228px; right: 467px">Please Enter the Manufacturer Name</asp:TextBox>
