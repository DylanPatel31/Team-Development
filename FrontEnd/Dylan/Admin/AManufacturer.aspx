<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AManufacturer.aspx.cs" Inherits="FrontEnd.Dylan.Admin.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtManufacturerName" runat="server" style="z-index: 1; left: 162px; top: 114px; position: absolute; bottom: 528px"></asp:TextBox>
        <asp:TextBox ID="txtManufacturerTelephone" runat="server" style="z-index: 1; left: 158px; top: 180px; position: absolute"></asp:TextBox>
        <asp:TextBox ID="txtManufacturerEmail" runat="server" style="z-index: 1; left: 216px; top: 248px; position: absolute"></asp:TextBox>
