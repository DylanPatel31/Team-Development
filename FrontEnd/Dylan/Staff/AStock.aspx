<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AStock.aspx.cs" Inherits="FrontEnd.Dylan.Staff.AStock" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:TextBox ID="txtMainColour" runat="server" style="z-index: 1; left: 155px; top: 194px; position: absolute"></asp:TextBox>
